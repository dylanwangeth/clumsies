...
[本地 Agent 活动](/zh/recall) 和 [macOS Reviews 设计](/zh/reviews-ui-design) 是已实现产品面的详细设计，也属于当前文档。它们必须随对应 Swift、daemon 和 Server 合同一起更新。

## 历史文档

以下页面只记录迁移或退役事实，不定义当前系统：

- [Project Memory 权威切换](/zh/project-authority-migration)
- [统一 Memory 存储边界迁移](/zh/guides/rule-store-unification)
- [Metaprompt 移除](/zh/meta-prompt)
- [已归档 Zig CLI](/zh/guides/cli-commands)
- [已归档 Zig TUI](/zh/tui)
- [已归档 attestation 客户端](/zh/attestation)
