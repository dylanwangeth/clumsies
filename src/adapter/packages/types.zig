...
pub const AdapterPackage = struct {
    ...
    repo_scope_description: ?[]const u8 = null,
    user_scope_description: ?[]const u8 = null,
    remove_repo_scope_description: ?[]const u8 = null,
    remove_user_scope_description: ?[]const u8 = null,
    resolve_target_root_fn: *const fn (allocator: std.mem.Allocator, scope: model.Scope, repo_root_opt: ?[]const u8) anyerror!?[]const u8,
    ...
    pub fn resolveTargetRoot(self: AdapterPackage, allocator: std.mem.Allocator, scope: model.Scope, repo_root_opt: ?[]const u8) !?[]const u8 {
        return self.resolve_target_root_fn(allocator, scope, repo_root_opt);
    }
