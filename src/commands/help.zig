...
pub fn run(stdout: anytype) !void {
    ...
    try stdout.print("{s}    {s}search{s} [task]       Search templates and prompts\n", .{ P, Color.cyan, Color.reset });
    ...
    try stdout.print("{s}    {s}--command-only{s}      Show only command prompts\n", .{ P, Color.cyan, Color.reset });
    try stdout.print("{s}    {s}--conduct-only{s}      Show only conduct prompts\n", .{ P, Color.cyan, Color.reset });
    ...
    try stdout.print("{s}    {s}clumsies search{s}                      {s}# List all (templates + prompts){s}\n", .{ P, Color.cyan, Color.reset, Color.dim, Color.reset });
    try stdout.print("{s}    {s}clumsies search coding{s}               {s}# Filter by task \"coding\"{s}\n", .{ P, Color.cyan, Color.reset, Color.dim, Color.reset });
    try stdout.print("{s}    {s}clumsies search --command-only{s}       {s}# Only command prompts{s}\n", .{ P, Color.cyan, Color.reset, Color.dim, Color.reset });
    try stdout.print("{s}    {s}clumsies search coding --conduct-only{s} {s}# Conduct for \"coding\" task{s}\n", .{ P, Color.cyan, Color.reset, Color.dim, Color.reset });
